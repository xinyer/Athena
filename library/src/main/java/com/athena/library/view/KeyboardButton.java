...
public class KeyboardButton extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        numberTextColor = typedArray.getColor(R.styleable.KeyboardButton_number_text_color, getResources().getColor(R.color.keyboard_btn_num_color));
        letterTextColor = typedArray.getColor(R.styleable.KeyboardButton_letter_text_color, getResources().getColor(R.color.keyboard_btn_text_color));
