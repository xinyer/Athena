...
public class SearchDataCenter {
    ...
    private List<SearchableEntity> searchDataCache = new ArrayList<SearchableEntity>();
    private List<SearchableEntity> searchResultList = new ArrayList<SearchableEntity>();

    private OnSearchCompleteListener completeListener = null;
     ...
     * 搜索数据初始化Task
     */
    private class SearchDataInitTask extends AsyncTask<Object, Void, Void> {
        @Override
     ...
     * 搜索数据初始化Task
     */
    private class SearchDataAppendTask extends AsyncTask<Object, Void, Void> {
        @Override
        protected Void doInBackground(Object... params) {
            for (Object o : params) {
                searchDataCache.add(getSearchData(o));
    ...
    public interface OnSearchCompleteListener {
        void onComplete(List<SearchableEntity> list);
    }
     ...
     */
    private void updateSearchData(Object o, DataAction action) {
